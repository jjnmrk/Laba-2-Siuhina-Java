...
public class Solution {
     ...
     */
    public static List<Token> toPostfixForm(final String equation, final List<ValueToken> vars) {
        List<Token> result = new List<>();
        List<Token> tokens = Lexer.getTokens(equation, vars);
     ...
     */
    public static Double calcEquation(final String equation, List<ValueToken> vars) {
        List<Token> postfixForm = toPostfixForm(equation, vars);
     ...
     */
    public static boolean isProperlyArranged(final String equation, final List<Token> tokens) {
