...
public class Lexer {
     ...
     */
    public static List<Token> getTokens(final String equation, final List<ValueToken> vars) {
     ...
     */
    public static int findVar(final String varName, final List<ValueToken> vars) {
        String var = varName;
